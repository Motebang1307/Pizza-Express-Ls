...
<?php
    ...
    $restaurant_name = "Pizza Express Ls";
    $restaurant_email = "expresspizza@gmail.com";
    $restaurant_address = "next to the DLM complex, opposite Khubetswana hardware in Maseru";
    $restaurant_phonenumber = "+266 56560456 / 64000641";
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	              				We’re proud to support local farmers and suppliers. Most of our fresh ingredients from vegetables to meats
								and dairy, are sourced right here in Lesotho. By choosing local, we help grow our community’s economy, reduce
								our environmental footprint, and ensure every pizza is made with the freshest, most authentic local flavor. 
								Supporting local never tasted this good!
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
								Enjoy your favorite meals without leaving your comfort zone! At Pizza Express Ls, we offer free delivery on
								all orders of "M110.00" or more. Whether you’re at home, the office, or hanging out with friends, we’ll bring 
								your hot, freshly made pizza straight to your door fast, convenient, and at no extra cost. Sit back, relax,
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	We believe great taste starts with great ingredients. That’s why we use only the freshest, locally sourced 
								produce, premium meats, and high-quality cheeses in every pizza we make. From our hand-stretched dough to 
								our signature sauces prepared daily, every bite delivers authentic flavor and unbeatable freshness. Whether 
								you’re dining in or ordering for delivery, we serve quality you can taste, because you deserve nothing less
								than the best.
	                        </p>
	                    </div>
	                </div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
                            Our mission is to serve high-quality, affordable meals that satisfies every craving and creates memorable moments for our customers.
                        </p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/logo.png" alt="Restaurant Logo" style="width: 50px;margin-bottom: 20px;">
                        <p>
                            Our Restaurnt Store is one of the best, provide tasty Menus and Dishes. You can reserve a table or Order food.
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday    : 07:00am - 09:00pm</li>
                            <li>Tuesday   : 07:00am - 09:00pm</li>
                            <li>Wednesady : 07:00am - 09:00pm</li>
                            <li>Thursday  : 07:00am - 09:00pm</li>
							<li>Friday    : 07:00am - 09:00pm</li>
							<li>Satarday  : 07:00am - 09:00pm</li>
							<li>Sunday    : 08:00am - 08:00pm</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
