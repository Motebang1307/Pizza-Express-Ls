...
(1, 'Moroccan Tajine', 'piz.jpg'),
(2, 'Italian Pasta', 'delivery.jpg'),
(3, 'Cook', 'mello.jpg'),
(4, 'Pizza', 'img_3.jpg'),
...
(1, 'Mocktails', 'If you want to skip the alcohol, sip the flavor instead.',14.00, '28101_couscous_meat.png', 8),
(2, 'BBQ Chicken & Mashrooms', 'Delicious baked dough topped with cheese, sauce, and tasty toppings.',115.00, 'bbq.jpg', 1),
(3, 'Single Burger', 'Juicy grilled patty served in a bun with fresh toppings.',35.50, 'burger.jpeg', 2),
(5, 'Cocktails', 'Refreshing beverages to enjoy, from soft drinks to chilled cocktails.',20.00, 'coffee.png', 3),
(6, 'Coffee', 'Refreshing beverages to enjoy, from soft drinks to chilled cocktails',30.20, 'coffee.jpeg', 3),
(7, 'Platter for 2', 'A hearty mix of favorites, perfect for sharing and full meals.',200.00, 'macaroni.jpg', 4),
(8, 'Platter for 5', 'A hearty mix of favorites, perfect for sharing and full meals.',350.00, 'cooked_pasta.jpg', 4),
(9, 'Large Fries', 'Crispy, golden potato fries served hot and perfectly seasoned.',25.00, 'fries.png', 5),
(11, 'CreateYourOwn Meal', 'Build your perfect combo, choose your favorites and make it yours.',50.00, '58146_Moroccan Chicken Tagine.jpeg', 8),
(12, 'Drinks & Bevs.', 'Cool, refreshing drinks to complement every meal and mood.',10.00, '76643_ice_tea.png', 8),
(16, 'CreateYourOwn Cocktail', 'Mix it your way; craft a cocktail that matches your vibe.',30.00, '76643_ice_tea.jpg', 8);
...
(1, 'restaurant_name', 'Pizza Express Ls'),
(2, 'restaurant_email', 'expresspizza595@gmail.com'),
(3, 'admin_email', 'motebanglekhooana@gmail.com'),
(4, 'restaurant_phonenumber', '+266 56560456 / 64000641'),
(5, 'restaurant_address', 'Next to the DLM complex, opposite Khubetswana hardware in Maseru');
